...
namespace Hunter.WebUI.DataAnnotations.Internal
{
    public class CompareAttributeAdapter : AttributeAdapterBase<CompareAttribute>
    {
        ...
        public override void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-msg-equalto", GetErrorMessage(context));
            MergeAttribute(context.Attributes, "equalto", _otherProperty);
        }
        ...
        private sealed class CompareAttributeWrapper : CompareAttribute
        {
            ...
            public static string GetOtherPropertyDisplayName(ModelValidationContextBase validationContext, CompareAttribute attribute)
            {
